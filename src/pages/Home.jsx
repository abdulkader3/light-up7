...
const Home = () => {
  useEffect(()=>{axios.get('https://api.jsonbin.io/v3/b/6672cd79e41b4d34e405935d')
    ...
    <div className=" w-full h-full gap-[20px] bg-slate-700 flex flex-wrap justify-center items-center justify-evenly ">
      {
        ...
        <div key={chabi} className=" w-[400px] h-[720px]  bg-white  flex flex-col items-center ">
          <div className="img w-[150px] h-[220px]  ">
             <img src={apibox.image} alt="photo" />
              ...
              <div className="">
                ...
                <div className=" text-[25px] font-semibold text-green-500 "><p> Price :  {apibox.price} </p></div>
              </div>
